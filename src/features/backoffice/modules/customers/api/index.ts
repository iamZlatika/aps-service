import { PaginatedCustomersDtoSchema } from "@/features/backoffice/modules/customers/api/dto.ts";
import { CUSTOMERS_API } from "@/features/backoffice/modules/customers/api/endpoints";
import { mapPaginatedCustomersDtoToResponse } from "@/features/backoffice/modules/customers/lib/adapters.ts";
...
export const customersApi = {
  getAll: async (
    ...
    const response = await get(
      `${CUSTOMERS_API.listCustomers()}?${params.toString()}`,
    );
