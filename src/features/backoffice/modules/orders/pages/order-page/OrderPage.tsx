              ...
              <div className="flex h-full">
                <div className="flex-1 overflow-y-auto p-2 pb-14 sm:p-6 [scrollbar-gutter:stable]">
                  <div className="flex flex-col gap-1.5">
                    <Skeleton className="h-7 w-44 sm:h-9 sm:w-64" />
                  ...
                  <div className="flex flex-col gap-6 mt-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 items-start">
                      <Skeleton className="h-72 flex-1 min-w-0 w-full" />
                ...
                {!isMobile && <HistorySidebar orderId={orderId} history={[]} />}
              </div>
              {isMobile && (
                <MobileHistoryDrawer orderId={orderId} history={[]} />
              )}
            </>
          ) : (
            <>
