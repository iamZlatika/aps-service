...
import { mapTelegramDtoToTelegram } from "@/features/backoffice/modules/customers/lib/adapters.ts";
import type { CustomerTelegramLinkedSocketEvent } from "@/features/backoffice/modules/customers/types.ts";
