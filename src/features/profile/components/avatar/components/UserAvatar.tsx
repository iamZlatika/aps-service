...
const AvatarEditorDialog = lazy(
  () =>
    import("@/features/profile/components/avatar/components/AvatarEditorDialog.tsx"),
);
import { useAvatarDelete } from "@/features/profile/components/avatar/hooks/useAvatarDelete.ts";
import { useAvatarUpload } from "@/features/profile/components/avatar/hooks/useAvatarUpload.ts";
import EditButton from "@/features/profile/components/buttons/EditButton.tsx";
import { isCustomAvatar } from "@/features/profile/lib/isCustomAvatar.ts";
